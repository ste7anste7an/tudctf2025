...
Build Lagrange basis polynomials P_i(x)
...
Evaluate each basis polynomial at x = 50,51,52,53
...
Scale and form block matrix M = [I | A]
...
Interpret the lattice structure
...
Closest-vector search in the integer lattice
